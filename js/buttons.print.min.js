...
(function(b) {
        ...
        action: function(a, e, p, k) {
            ...
            if (c) {
                ...
                try { c.document.head.innerHTML = q }
                attraper(f) { b(c.document.head).html(q) }
                ...
                navigator.userAgent.match(/Trident\/\d .\ré/) ?
                    a() : c.setTimeout(a, 1E3)
            } else e.buttons.info(e.i18n("buttons.printErrorTitle", "Impossible d'ouvrir la vue avant impression"), e.i18n("buttons.printErrorMsg", " Veuillez autoriser les fenêtres contextuelles dans votre navigateur pour que ce site puisse afficher la vue avant impression."), 5E3)
        },
        title: "*",
        messageTop: "*",
        messageBottom: "*",
