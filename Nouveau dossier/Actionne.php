    ...
    $prenom=$_POST['prenom'];
            ...
            $montantValidation=$_POST['montantValidation'];
                if ($preCompteSolde=="preCompteSolde") {
                    ...
                    $req3=$conn->prepare("INSERT INTO `agent` (`IM`, `Nom`, `Prenom`, `DateEntreAdmission`, `DateIntegration`, `DateTitularisation`, `DateDepartRetraite`, `Validation`, `NumOrdreRecette`, `MontantValidation`, `PrecompteSolde`, `Integral`, `Partiel`,`DatePaiment`, `NonEncorePaye`, `Observation`,`UADM`,recensement)
                     VALUES ('$num','$nom','$prenom','$dateEntreAdmission','$dateIntegration','$dateTitularisation','$dateDepartRetraite','$valid','$numOrdreRecette','$montantValidation','$preCompteSoldes','$integ','$partiel','$datePaiments','$nonPaye','$observation','$uadm','$recensement')");
                    $req3->execute($table);
                    ?>
                    <script type="text/javascript">
        ...
        if ($validation=="1") {
            ...
            if ($preCompteSolde=="preCompteSolde") {
                ...
                $rec=$conn->prepare("UPDATE agent SET DateEntreAdmission='$dateEntreAdmission',DateIntegration='$dateIntegration',DateTitularisation='$dateTitularisation',DateDepartRetraite='$dateDepartRetraite',`Validation`='$valid',NumOrdreRecette='$numOrdreRecette',MontantValidation='$montantValidation',`PrecompteSolde`='$preCompteSoldes',Integral='$integ',Partiel='$partiel',`DatePaiment`='$datePaiments',NonEncorePaye='$nonPaye',Observation='$observation',recensement='$recensement' WHERE IM='$num' ");
                $rec->execute($table);
                ?>
                <script type="text/javascript">
                ...
                if ($integral=="Integral") {
                    ...
                    $nonPaye=0;
                    $table=array($dateEntreAdmission,$dateIntegration,$dateTitularisation,$dateDepartRetraite,$valid,$numOrdreRecette,$montantValidation,$preCompteSoldes,$integ,$partiel,$datePaiments,$nonPaye,$observation,$recensement);
                    $rec1=$conn->prepare("UPDATE agent SET DateEntreAdmission='$dateEntreAdmission',DateIntegration='$dateIntegration',DateTitularisation='$dateTitularisation',DateDepartRetraite='$dateDepartRetraite',`Validation`='$valid',NumOrdreRecette='$numOrdreRecette',MontantValidation='$montantValidation',`PrecompteSolde`='$preCompteSoldes',Integral='$integ',Partiel='$partiel',`DatePaiment`='$datePaiments',NonEncorePaye='$nonPaye',Observation='$observation',recensement='$recensement' WHERE IM='$num' ");
                    $rec1->execute($table);
                    ?>
                <script type="text/javascript">
                    alert("Modification reuissie !");
